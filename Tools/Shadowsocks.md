...
2. یکی از کدهای صفحه کانفیگ زیر را کپی کنید.
...
برای استخراج این جزئیات از URLهای موجود در لیست سرورها می‌توانید از این [اسکریپت](https://github.com/WeAreMahsaAmini/FreeInternet/blob/main/utils/ss-link-to-json/ss-link-to-json.py) استفاده کنید.
